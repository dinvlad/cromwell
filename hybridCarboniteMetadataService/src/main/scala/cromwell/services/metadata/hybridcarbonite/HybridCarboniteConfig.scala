...
object HybridCarboniteConfig {
  ...
  def parseConfig(carboniterConfig: Config)(implicit system: ActorSystem): Checked[HybridCarboniteConfig] = {
    ...
    val minimumSummaryEntryId = carboniterConfig.as[Option[Long]]("minimum-summary-entry-id")
    ...
    } yield HybridCarboniteConfig(enable, minimumSummaryEntryId, pathBuilders, bucket)
  }
}
